...
- **Decision needed:** does this rewrite bump the instruction contract version, and by how much? It doesn't break any documented command or file layout by itself, so treat it as **minor** (1.3.0 → 1.4.0) unless a later stage (e.g. new required scripts in Stage 3/5) forces **major**. Revisit at the end of Stage 5.
